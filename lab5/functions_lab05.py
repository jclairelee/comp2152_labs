...
def collect_loot(loot_options, belt):
    ...
    loot_roll = random.choice(range(len(loot_options)))  # Simplified range
    loot = loot_options.pop(loot_roll)  # Directly popping without subtracting 1
    belt.append(loot)
